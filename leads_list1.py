...
#         'Wallet Value (USD)': [1000, 500, 2000, 1500],
#         'Gambling User Y/N': ['N', 'Y', 'N', 'Y'],
#         'Deposit Value': [500, 1000, 1500, 200],
#         'TLV': [1500, 1500, 3500, 1700],
#         'Last Transaction Date': ['2022-05-01', '2023-03-15', '2023-04-20', '2023-05-25'],
#         'Email': ['John33@gmail.com', 'Allenkjb@gmail.com', 'Opal@gmail.com', 'CryptoJacob@hotmail.com'],
#         'Twitter': ['@John33', '@Allenkjb', '@Opal', '@CryptoJacob'],
#         'Telegram': ['@John33', '@Allenkjb', '@Opal', '@CryptoJacob'],
#         'Discord': ['John33#1234', 'Allenkjb#1234', 'Opal#1234', 'CryptoJacob#1234'],
#         'linkedin': ['John33', 'Allenkjb', 'Opal', 'CryptoJacob'],
#     }
...
#         'Wallet/User': ['0x29ab82Ec552573b1B7d4933B2AaA3C568be9C6D1', '0xBE7CE5358977B00868C52045fb6c2790514efE68', '0xc9a648CF30D16079e48404F6Fd1Fd7Be83650C4d', '0xB5A16b3962BAcEB2CB292047333b58AaD1E060EE'],
#         'Wallet Value (USD)': [1000, 500, 2000, 1500],
#         'Liquidity Provider Y/N': ['N', 'Y', 'N', 'Y'],
#         'Deposit Value': [500, 1000, 1500, 200],
#         'TLV': [1500, 1500, 3500, 1700],
#         'Last Transaction Date': ['2022-05-01', '2023-03-15', '2023-04-20', '2023-05-25'],
#         'Email': ['John33@gmail.com', 'Allenkjb@gmail.com', 'Opal@gmail.com', 'CryptoJacob@hotmail.com'],
